...
return(
    <div>
        <form onSubmit={SignUpMethod} className="flex flex-col space-y-4">
            ...
            <input type="text" name="name" id="name" className="p-2 rounded-md bg-[#000000] border border-[#1DCD9F] text-white" onChange={(e)=>setUserData({...userData,[e.target.name]:e.target.value})}/>
            <label htmlFor="email" className="font-medium">Email</label>
            <input type="email" name="email" id="email" className="p-2 rounded-md bg-[#000000] border border-[#1DCD9F] text-white" onChange={(e)=>setUserData({...userData,[e.target.name]:e.target.value})}/>
            <label htmlFor="password" className="font-medium">Password</label>
            <input type="password" name="password" id="password" className="p-2 rounded-md bg-[#000000] border border-[#1DCD9F] text-white" onChange={(e)=>setUserData({...userData,[e.target.name]:e.target.value})}/>
